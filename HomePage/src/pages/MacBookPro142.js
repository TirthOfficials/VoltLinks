      ...
      <div className={styles.voltlinks}>
        <div className={styles.homePage}>
          ...
          <div className={styles.topMenuBanner}>
            ...
            {/* <a href="http://localhost:3001" className={styles.buy} target="_blank" rel="noopener noreferrer">Buy</a> */}
...
<SellComponent /> */}
          ...
          <a href="http://localhost:3001" className={styles.buyText} target="_blank" rel="noopener noreferrer">BUY</a>
          {/* <div className={styles.buyText}>BUY</div> */}
          <div className={styles.homePageInner} />
          <a href="http://localhost:3001" className={styles.sellText} target="_blank" rel="noopener noreferrer">SELL</a>
